...
// Config and media live in ONE fixed place in the user's Documents, never next to
// the app. This is what makes the controller work no matter where the app runs
// from — in its folder, from Applications, or from the temporary copy macOS uses
// for unsigned apps. Nothing is looked up relative to the app.
const DATA_DIR = path.join(os.homedir(), 'Documents', 'CSDtv Ad Controller');
