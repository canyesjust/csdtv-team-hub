...
const CAT_STYLES: Record<string, { bg: string; color: string; emoji: string }> = {
  Tools:         { bg: 'rgba(30,108,181,0.12)',  color: 'var(--brand-primary)', emoji: '🛠' },
        ...
        <div style={{ display: 'flex', gap: '6px', marginBottom: '20px', flexWrap: 'wrap' }}>
          <button
            ...
            style={{
              ...
              padding: '7px 16px',
              borderRadius: '20px',
              border: `0.5px solid ${catFilter === 'all' ? 'var(--brand-primary)' : border}`,
              background: catFilter === 'all' ? 'rgba(30,108,181,0.12)' : cardBg,
              color: catFilter === 'all' ? 'var(--brand-primary)' : muted,
              cursor: 'pointer',
              fontFamily: 'inherit',
              minHeight: '36px',
            }}
