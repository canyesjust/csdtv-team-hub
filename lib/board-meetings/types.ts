...
export type BoardMeetingRecord = {
  ...
  /** Operator-entered start times for the public Watch page (wall-clock, America/Denver). */
  public_start_times?: { meeting: string | null; sections: Record<string, string> } | null
